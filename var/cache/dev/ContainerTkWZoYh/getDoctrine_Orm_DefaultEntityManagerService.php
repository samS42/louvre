...
$b->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\NewOrderRepository' => function () {
    return ($this->privates['App\Repository\NewOrderRepository'] ?? $this->load('getNewOrderRepositoryService.php'));
