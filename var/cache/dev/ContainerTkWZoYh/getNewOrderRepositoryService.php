...
// Returns the private 'App\Repository\NewOrderRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\NewOrderRepository.php';

return $this->privates['App\Repository\NewOrderRepository'] = new \App\Repository\NewOrderRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
